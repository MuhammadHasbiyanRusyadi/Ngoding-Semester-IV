...
<form action="" method="POST">
    ...
    <?php 
        if(isset($_POST['submit'])) {
            ...
            else if($asal == "Celcius" && $tujuan == "Rheamur") {$hslkonver = 4/5 * $nilai; echo "<h2>Hasil Konversi $hslkonver °R</h2>"; }
            ...
            else if($asal == "Fahrenheit" && $tujuan == "Rheamur") {$hslkonver = 4/9 * ($nilai - 32); echo "<h2>Hasil Konversi $hslkonver °R</h2>";}
            else if($asal == "Fahrenheit" && $tujuan == "Kelvin") {$hslkonver = 5/9 * ($nilai + 459.67); echo "<h2>Hasil Konversi $hslkonver °K</h2>";}

            else if($asal == "Rheamur" && $tujuan == "Celcius") {$hslkonver = 5/4 * $nilai; echo "<h2>Hasil Konversi $hslkonver °C</h2>";}
            else if($asal == "Rheamur" && $tujuan == "Fahrenheit") {$hslkonver = 9/4 * $nilai + 32; echo "<h2>Hasil Konversi $hslkonver °F</h2>";}
            else if($asal == "Rheamur" && $tujuan == "Kelvin") {$hslkonver = 5/4 * $nilai + 273.15; echo "<h2>Hasil Konversi $hslkonver °K</h2>";}
            ...
            else if($asal == "Kelvin" && $tujuan == "Rheamur") {$hslkonver = 4/5 * ($nilai - 273.15); echo "<h2>Hasil Konversi $hslkonver °R</h2>";}}?>
</body>
</html>